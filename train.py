...
parser.add_argument('--train_dataset', '-data_tr', type=str, default="data/gps_20161101_5006_dataset_small.json")
parser.add_argument('--validate_dataset', '-data_va', type=str, default="data/gps_20161102_517_dataset_small.json")

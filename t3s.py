...
class MetricLearningDataset(tud.Dataset):
    def __init__(self, file_train, triplet_num, max_len):
        """
...
class T3S(nn.Module):
    def __init__(self, vocab_size, dim_emb, max_len, heads, encoder_layers=2, lstm_layers=1, pre_emb=None):
...
def train_t3s(args):
    ...
    test_loader = tud.DataLoader(test_dataset, batch_size=batch_size, shuffle=True, collate_fn=collate_fn)
